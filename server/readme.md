# Fuji - Llama
This is a Llama Card game server written in GO. T
his is my first project in GO and mostly copied from Eric Carr's work on 5 card stud and Fujitzee, 

I have done the minimum changes to the 

Main
lobbyClient
and util 

and marked the up where I did etc. 

All game logic is taken from Eric code too and modified to suit this game etc, (kind of hoping other will see that it;s relatively  easy to write a fujinet card game)
...
1. You may call the public api at TBD 
